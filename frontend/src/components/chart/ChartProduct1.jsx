...
export default class ChartProduct1 extends Component {

    render() {
        return (
            <div className="chart">
                <div className="chart-1">
                    <h5 className="title">Geladeira Refrigerador Electrolux DC35A Cycle</h5>
                    <BarChart
                        width={550}
                        height={300}
                        data={data}
                ...
                <div className="chart-2">
                    <h5 className="title">Micro-ondas 25L Philco Pme25 Espelhado</h5>
                    <BarChart
                        width={550}
                        height={300}
                        data={data}
